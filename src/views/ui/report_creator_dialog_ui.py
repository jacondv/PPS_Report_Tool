...
"")
        ...
        self.cloud_over_viewer.setMinimumSize(QSize(400, 300))
        ...
        self.cloud_viewer.setMinimumSize(QSize(400, 300))
        ...
        self.chart_viewer.setMinimumSize(QSize(200, 0))
